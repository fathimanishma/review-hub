          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                AppText(text: 'Movies', weight: FontWeight.w500, size: 18, textcolor: customBalck),
                 RatingBar.builder(
              initialRating: 5,
              minRating: 1,
                ...
                return Container(
                  ...
                  child: Column(
                    children: [
                      Stack(
                        children: [
                          Image.asset('assets/images/premalu.jpg',fit: BoxFit.cover,),
                          Column(
                      ...
                      Row(
                        children: [
                          AppText(text: 'Premalu', weight: FontWeight.w500, size: 15, textcolor: customBalck),
                        ],
                      )
                    ],
                  ),
