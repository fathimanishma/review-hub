          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                AppText(text: 'Channel', weight: FontWeight.w500, size: 18, textcolor: customBalck),
                 RatingBar.builder(
              initialRating: 5,
              minRating: 1,
                ...
                return Container(
                  ...
                  child: Column(
                    children: [
                      Stack(
                        children: [
                          Image.asset('assets/images/asianet.jpg',fit: BoxFit.cover,),
                          Column(
                      ...
                      Row(
                        children: [
                          AppText(text: 'Asianet', weight: FontWeight.w500, size: 15, textcolor: customBalck),
                        ],
                      )
                    ],
                  ),
